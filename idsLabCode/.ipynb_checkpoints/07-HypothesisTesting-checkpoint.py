...
data = np.genfromtxt('Resources/movieRatingsDeidentified.csv', delimiter = ',', skip_header = 1)
...
# 1. Load data:
df = pd.read_csv('Resources/movieRatingsDeidentified.csv',skipinitialspace=True)
