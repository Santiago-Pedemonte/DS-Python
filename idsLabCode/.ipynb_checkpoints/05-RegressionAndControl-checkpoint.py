...
data = np.genfromtxt('Resources/determinedIncome.csv',delimiter=',') # load file as data
...
# 0. Load:
data = np.genfromtxt('Resources/iqIncome.csv',delimiter=',') # Column 1 = IQ, 2 = income
...
#%% Custom SLR function
from Resources/simple_linear_regress_func import simple_linear_regress_func # import
...
# 0. Load:
data = np.genfromtxt('Resources/determinedIncome.csv',delimiter=',') # IQ, hours worked, years education, income
...
# 0. Load:
data = np.genfromtxt('Resources/leadIncome.csv',delimiter=',') # income, violent incidents, lead levels
